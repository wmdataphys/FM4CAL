...
Code taken from
https://github.com/hqucms/weaver-core/blob/main/weaver/utils/nn/optimizer/lookahead.py
"""
...
class Lookahead(Optimizer):
    ...
    def _backup_and_load_cache(self):
        """Useful for performing evaluation on the slow weights (which typically generalize
        better)"""
        for group in self.optimizer.param_groups:
            for p in group["params"]:
                param_state = self.state[p]
